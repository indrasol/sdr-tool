...
interface CreateProjectModelDialogProps {
  ...
  project?: ProjectModel | null; // Optional prop for editing a project
  onSave?: (project: ProjectModel) => void; // Optional prop for saving edited project
}
...
export function CreateProjectModel({
  ...
  const handleCreateProject = () => {
    const newProject: ProjectModel = {
      ...
      name,
      version,
      status: project ? project.status : "Started", // Default status
      ...
      priority: project ? project.priority : "1-High", // Default priority
