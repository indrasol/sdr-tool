...
const CreateProjectDialog = ({ 
  ...
  const handleSetDefaultCreator = () => {
    if (user && !creatorName) {
      setCreatorName(user.username || user.email || '');
    }
  };

  // Set default creator when dialog opens
  const handleDialogOpenChange = (open: boolean) => {
    if (open) {
      console.log("Creator Name : ",creatorName)
      handleSetDefaultCreator();
    }
            ...
            <div className="space-y-2">
              ...
              >
                ...
                <SelectContent className="bg-white">
                  ...
                  <SelectItem value="On Hold">Planned</SelectItem>
                </SelectContent>
              </Select>
            </div>
          </div>
