...
//       // Generate a simplified data flow view (will be replaced with actual implementation)
//       const dataFlowNodes = preparedNodes.map(node => ({
//         ...node,
//         data: {
//           ...node.data,
//           isDataFlowView: true
...
//       // Create simplified data flow edges - typically would connect only data-related nodes
//       const dataFlowEdges = processedEdges.map(edge => ({
//         ...edge,
//         animated: true,
//         style: {
//           ...edge.style,
//           stroke: '#3182ce', // Blue color for data flow
//           strokeWidth: 3,
//         }
//       }));
      
//       // Store the data flow diagram
//       dataFlowDiagramRef.current = {
//         nodes: dataFlowNodes,
//         edges: dataFlowEdges
//       };
...
//         // Switch to data flow diagram
//         setNodes(dataFlowDiagramRef.current.nodes);
//         setEdges(dataFlowDiagramRef.current.edges);
//       } else {
//         // Switch back to original diagram
//         setNodes(originalDiagramRef.current.nodes);
//         setEdges(originalDiagramRef.current.edges);
...
//   // Display loading state if no nodes yet
//   if (!nodes || nodes.length === 0) {
//     return (
//       <div className="h-full w-full flex flex-col items-center justify-center">
//         <p>Loading diagram...</p>
