          ...
          {viewMode === 'AD' && (
            <Panel position="top-left" className="ml-4 mt-3">
              <button
                ...
                className="p-2 bg-securetrack-purple/10 rounded shadow-sm text-xs hover:bg-securetrack-purple/20 text-securetrack-purple transition-colors font-medium flex items-center gap-1"
              >
